...
class FunctionModel
{
    private $functions = [
        ...
        "SP_INS_CLIENT" => [
            "query" => 'CALL SP_INS_CLIENT(:userid, :username, :first_name, :last_name, :doc_type, :doc_number, :user_email, :phone, :password, :status, :type, :createdby)',
            "params" => ['userid', 'username', 'first_name', 'last_name', 'doc_type', 'doc_number', 'user_email', 'phone', 'password', 'status', 'type', 'createdby']
        ],
        "SP_INS_USER" => [
