...
class FunctionModel
{
    private $functions = [
        ...
        "SP_INS_USER" => [
            "query" => 'CALL SP_INS_USER(:id, :user, :first_name, :last_name, :doc_type, :doc_number, :user_email, :phone, :password, :status, :type, :username)',
            "params" => ['id', 'user', 'first_name', 'last_name', 'doc_type', 'doc_number', 'user_email', 'phone', 'password', 'status', 'type', 'username']
        ],
        "SP_SEL_DRIVER" => [
