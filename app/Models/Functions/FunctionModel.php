...
class FunctionModel
{
    private $functions = [
        ...
        "SP_INS_USER" => [
            "query" => 'CALL SP_INS_USER(:id, :id_role, :username, :first_name, :last_name, :doc_type, :doc_number, :user_email, :phone, :password, :status, :type)',
            "params" => ['id', 'id_role', 'username', 'first_name', 'last_name', 'doc_type', 'doc_number', 'user_email', 'phone', 'password', 'status', 'type']
        ],
        /**
