        ...
        try {
            ...
            foreach ($data as $key => &$value) {
                DB::table('massive_load_details')->insert([
                    ...
                    'client_name' => ($type === 'Logistica inversa') ? $value->seller_name : $value->collect_client_name,
                    ...
                    'seller_name' => ($type === 'Logistica inversa') ? $value->collect_client_name : $value->seller_name,
