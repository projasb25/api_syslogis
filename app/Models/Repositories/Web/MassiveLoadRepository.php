...
class MassiveLoadRepository
{
    ...
    public function get_datos_ruta_cargo_ripley($id)
    {
        $query = DB::select("select
            gd.guide_number, gd.client_barcode, gd.client_name, gd.client_phone1, gd.client_email, gd.client_dni, gd.type, gd.collect_time_range, gd.collect_contact_name, gd.client_date,
            org.name, org.address as org_address, adr.district, adr.province, adr.address, adr.address_refernce,
